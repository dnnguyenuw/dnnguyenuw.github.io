function createNewPatient(){
  ...
  var patient_str = localStorage.getItem('patient3');
  if (localStorage.getItem('patient3') !== null){
    ...
    localStorage.setItem('patient3', JSON.stringify(patient_entry));
      }
...
function addNewRecord(type, content){
  var unparsed_patient_entry = localStorage.getItem('patient3');
