function createNewPatient(){
  ...
  var patient_str = localStorage.getItem('patient');
  if (localStorage.getItem('patient') !== null){
    ...
    localStorage.setItem('patient', JSON.stringify(patient_entry));
      }
...
function addNewRecord(type, content){
  var unparsed_patient_entry = localStorage.getItem('patient');
